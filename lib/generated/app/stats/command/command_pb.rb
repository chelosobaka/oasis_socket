  ...
  module App
    module Stats
      module Command
        ...
        GetStatsOnlineIpListResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("xray.app.stats.command.GetStatsOnlineIpListResponse").msgclass
        GetAllOnlineUsersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("xray.app.stats.command.GetAllOnlineUsersRequest").msgclass
        GetAllOnlineUsersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("xray.app.stats.command.GetAllOnlineUsersResponse").msgclass
